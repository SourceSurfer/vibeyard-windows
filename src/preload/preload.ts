...
export interface VibeyardApi {
  ...
  settings: {
    ...
    setInstallClaudeHooks(value: 'enabled' | 'disabled'): Promise<{ success: boolean }>;
  };
  menu: {
...
const api: VibeyardApi = {
  ...
  settings: {
    ...
    setInstallClaudeHooks: (value) => ipcRenderer.invoke('settings:setInstallClaudeHooks', value),
  },
  menu: {
